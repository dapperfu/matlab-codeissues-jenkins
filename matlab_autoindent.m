% 0 - ChatGPT: Write a MATLAB script to automate opening a matlab file using the editor (doc matlab.desktop.editor). Use the appropriate function to auto indent (Ctrl-I).
